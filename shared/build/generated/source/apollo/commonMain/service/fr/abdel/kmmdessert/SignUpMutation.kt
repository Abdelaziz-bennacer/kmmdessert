...
data class SignUpMutation(
  val userInput: UserInput
) : Mutation<SignUpMutation.Data, SignUpMutation.Data, Operation.Variables> {
  @Transient
  private val variables: Operation.Variables = object : Operation.Variables() {
    override fun valueMap(): Map<String, Any?> = mutableMapOf<String, Any?>().apply {
      this["userInput"] = this@SignUpMutation.userInput
    }

    override fun marshaller(): InputFieldMarshaller = InputFieldMarshaller.invoke { writer ->
      writer.writeObject("userInput", this@SignUpMutation.userInput.marshaller())
    }
  }
  ...
  data class SignUp(
    ...
    fun marshaller(): ResponseFieldMarshaller = ResponseFieldMarshaller.invoke { writer ->
      writer.writeString(RESPONSE_FIELDS[0], this@SignUp.__typename)
      writer.writeString(RESPONSE_FIELDS[1], this@SignUp.token)
      writer.writeObject(RESPONSE_FIELDS[2], this@SignUp.user.marshaller())
    }
    ...
    companion object {
      ...
      operator fun invoke(reader: ResponseReader): SignUp = reader.run {
        val __typename = readString(RESPONSE_FIELDS[0])!!
      ...
      @Suppress("FunctionName")
      fun Mapper(): ResponseFieldMapper<SignUp> = ResponseFieldMapper { invoke(it) }
    }
  }
  ...
  data class Data(
    ...
    override fun marshaller(): ResponseFieldMarshaller = ResponseFieldMarshaller.invoke { writer ->
      writer.writeObject(RESPONSE_FIELDS[0], this@Data.signUp?.marshaller())
    }

    companion object {
      private val RESPONSE_FIELDS: Array<ResponseField> = arrayOf(
          ResponseField.forObject("signUp", "signUp", mapOf<String, Any?>(
      ...
      operator fun invoke(reader: ResponseReader): Data = reader.run {
        val signUp = readObject<SignUp>(RESPONSE_FIELDS[0]) { reader ->
          SignUp(reader)
        }
        Data(
          signUp = signUp
  ...
  companion object {
    const val OPERATION_ID: String =
        "af10dd63203d53bca786ec854bfa2bcba96bcef47afcb86260462055bb88c28d"
    ...
    val OPERATION_NAME: OperationName = object : OperationName {
      override fun name(): String = "SignUp"
    }
  }
}
